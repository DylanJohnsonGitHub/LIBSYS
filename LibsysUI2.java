...
//--------------------RETURN PANEL SETUP---------------------------------------------//
		...
		JButton returnISBNButton = new JButton("Search ISBN");
...
//-----------------------MANAGE MEMBER FRAME SETUP------------------------------------//
		...
		JTextField manageUserEmailText = new JTextField(25);
...
//--------------------------------FUNCTION-------------------------------------------------------------------//
		...
		bookNumButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/libsys","root","CSC331");   
					Statement stmt=con.createStatement();  
					String queryStatement = "select * from libsys_books where isbn = " + bookISBN;
		...
		userIDButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/libsys","root","CSC331");   
					Statement stmt=con.createStatement();  
					String queryStatement = "select * from libsys_members where id = " + memberID;
					ResultSet rs=stmt.executeQuery(queryStatement);  
					while(rs.next()){
						String hello = (rs.getString("id"));
						String goodbye = (rs.getString("username"));
		...
		searchISBNButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/libsys","root","CSC331");   
					Statement stmt=con.createStatement();  
					String queryStatement = "select * from libsys_books where isbn = " + searchISBN;
					ResultSet rs=stmt.executeQuery(queryStatement);  
					while(rs.next()){
						System.out.println("ISBN: " + rs.getString("ISBN") + "\nTitle: " + rs.getString("title") + "\nAuthor: " + rs.getString("author")
							+ "\nCopies: " + rs.getString("copies") + "\nChecked Out Copies: " + rs.getString("checked") + "\n"); 
					}
				}catch(Exception a){ System.out.println(a);}
		...
		searchTitleButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/libsys","root","CSC331");   
					Statement stmt=con.createStatement();  
					String queryStatement = "select * from libsys_books where title like '%" + searchTitle + "%'";
					ResultSet rs=stmt.executeQuery(queryStatement);  
					while(rs.next()){
						System.out.println("ISBN: " + rs.getString("ISBN") + "\nTitle: " + rs.getString("title") + "\nAuthor: " + rs.getString("author")
							+ "\nCopies: " + rs.getString("copies") + "\nChecked Out Copies: " + rs.getString("checked") + "\n"); 
		...
		searchAuthorButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/libsys","root","CSC331");   
					Statement stmt=con.createStatement();  
					String queryStatement = "select * from libsys_books where author like '%" + searchAuthor + "%'";
					ResultSet rs=stmt.executeQuery(queryStatement);  
					while(rs.next()){
						System.out.println("ISBN: " + rs.getString("ISBN") + "\nTitle: " + rs.getString("title") + "\nAuthor: " + rs.getString("author")
							+ "\nCopies: " + rs.getString("copies") + "\nChecked Out Copies: " + rs.getString("checked") + "\n"); 
		...
		//Searches for the user on the manage user panel
		manageUserSearchButton.addActionListener(new ActionListener() {
			
			public void actionPerformed(ActionEvent e) {
				
				String searchAuthor = manageUserIDText.getText();
				...
				try {
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/libsys","root","CSC331");   
					Statement stmt=con.createStatement();  
					String queryStatement = "select * from libsys_members where id = " + searchAuthor;
					ResultSet rs=stmt.executeQuery(queryStatement);  
					while(rs.next()){
						String goodbye = (rs.getString("username"));
						String maybe = (rs.getString("email"));
						String collins = (rs.getString("member_end"));
						manageUserNameText.setText(goodbye);
						manageUserEmailText.setText(maybe);
						manageUserMemberTilText.setText(collins);
					}
				}catch(Exception a){ System.out.println(a);}
				System.out.println(searchAuthor);
			}		
